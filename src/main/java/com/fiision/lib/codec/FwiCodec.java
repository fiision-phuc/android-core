...
public final class FwiCodec {
    ...
    static public FwiJson convertDataToJson(String  jsonData) {
		...
		try {
            ...
            mapper.enable(DeserializationFeature.USE_BIG_DECIMAL_FOR_FLOATS, DeserializationFeature.USE_BIG_INTEGER_FOR_INTS);

			Object objectMapper = mapper.readValue(URLDecoder.decode(jsonData,"UTF-8"), Object.class);
